...
3. **Add Accounts**
   ...
   - See [Account Management](/accounts/oauth) for details
...
<CardGroup cols={2}>
  <Card title="Add Accounts" icon="user-plus" href="/accounts/oauth">
    Set up OAuth authentication and add accounts
  </Card>
  <Card title="Configure API Proxy" icon="server" href="/api/proxy-setup">
